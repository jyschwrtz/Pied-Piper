...
ApplicationRecord.transaction do
  ...
  playlist17 = Playlist.create!(
    ...
    image_url: "sky_mika-mcdollar.jpg",
    date: 2017,
    genre: "pop"
  )
  ...
  song7 = Song.create!( song_name: "White Cows", filename: "01-1161940-Kellee+Maize-In+Tune+_J.+Glaze+Remix_.mp3", length: 347,  artist_id: thomas_hill.id)
  song8 = Song.create!( song_name: "the Tentative Legacy", filename: "02-1161934-Kellee+Maize-I+Insist+_J.+Glaze+Remix_.mp3", length: 304,  artist_id: thomas_hill.id)
  song9 = Song.create!( song_name: "Horn of Teleprompters", filename: "03-1161932-Kellee+Maize-Mad+Humans+_J.+Glaze+Remix_.mp3", length: 236,  artist_id: thomas_hill.id)
  song10 = Song.create!( song_name: "The Weeping's Chair", filename: "04-1161938-Kellee+Maize-Big+Plans+_J.+Glaze+Remix_.mp3", length: 257,  artist_id: thomas_hill.id)
  song11 = Song.create!( song_name: "Labour Behind the Toadstools", filename: "05-1161933-Kellee+Maize-Owl+Time+_J.+Glaze+and+Udachi+Remix_.mp3", length: 222,  artist_id: thomas_hill.id)
  song12 = Song.create!( song_name: "The Position Drink", filename: "06-1161935-Kellee+Maize-Catch+Me+_J.+Glaze+Remix_.mp3", length: 299,  artist_id: thomas_hill.id)
  song13 = Song.create!( song_name: "Bashing", filename: "07-1161936-Kellee+Maize-Fact+Is+_J.+Glaze+and+Udachi+Remix_.mp3", length: 216,  artist_id: donald_brown.id)
  song14 = Song.create!( song_name: "Dance Locals", filename: "08-1161937-Kellee+Maize-Hasta+Abajo+_J.+Glaze+and+Mike+Cash+Remix_.mp3", length: 220,  artist_id: donald_brown.id)
  song15 = Song.create!( song_name: "Frozen Gun", filename: "09-1161939-Kellee+Maize-In+the+Night+-+Game+of+Thrones+Remake+_J.+Glaze+Remix_.mp3", length: 303, artist_id: donald_brown.id)
  ...
  song22 = Song.create!( song_name: "Organization Count Eyes", filename: "07-1411198-Alexey+Baranov-Koto.mp3", length: 235, artist_id: jennifer_auston.id)
  song23 = Song.create!( song_name: "Implied", filename: "08-1408963-Alexey+Baranov-Round+Around.mp3", length: 256, artist_id: jennifer_auston.id)
  song24 = Song.create!( song_name: "Meandering Slivers", filename: "09-1409438-Alexey+Baranov-Bubble+Gum+Machine.mp3", length: 114, artist_id: jennifer_auston.id)
  song25 = Song.create!( song_name: "Sign Bashing", filename: "10-1408401-Alexey+Baranov-Lullaby+For+Phil.mp3", length: 198, artist_id: jennifer_auston.id)
  song26 = Song.create!( song_name: "Undobuted Wonder", filename: "11-1408400-Alexey+Baranov-Sunny+Day+Again+_Simple+Version_.mp3", length: 216, artist_id: jennifer_auston.id)
  song27 = Song.create!( song_name: "The Rings of Afflictions", filename: "Wordsmith_-_The_Statement.mp3", length: 171, artist_id: jennifer_auston.id)
  song28 = Song.create!( song_name: "German of Dungeon", filename: "THE_DLX_-_Two_Kids.mp3", length: 211, artist_id: jennifer_auston.id)
  song29 = Song.create!( song_name: "Reactionaries Without the Occastion", filename: "Melanie_Ungar_-_Crazy_Glue.mp3", length: 220, artist_id: jennifer_auston.id)
  ...
  song33 = Song.create!( song_name: "Behind the Undoubted Snake", filename: "01-1161940-Kellee Maize-In Tune _J. Glaze Rem_.mp3", length: 347,  artist_id: mika_mcdoller.id)
  song34 = Song.create!( song_name: "Healer Flys On a Advocates", filename: "02-1161934-Kellee+Maize-I+Insist+_J.+Glaze+Rem_.mp3", length: 304,  artist_id: tiffany_smith.id)
  song35 = Song.create!( song_name: "Luck Under Muffins", filename: "03-1161932-Kellee+Maize-Mad+Humans+_J.+Glaze+Rem_.mp3", length: 236,  artist_id: tiffany_smith.id)
  song36 = Song.create!( song_name: "The Ruby Picture", filename: "04-1161938-Kellee Maize-Big Plans _J. Glaze Rem_.mp3", length: 257,  artist_id: tiffany_smith.id)
  song37 = Song.create!( song_name: "The Flames of Romance", filename: "05-1161933-Kellee+Maize-Owl+Time+_J.+Glaze+anddachi+Remix_.mp3", length: 222,  artist_id: tiffany_smith.id)
  song38 = Song.create!( song_name: "The World's Tea", filename: "06-1161935-Kellee Maize-Catch Me _J. Glaze Rem_.mp3", length: 299,  artist_id: tiffany_smith.id)
  song39 = Song.create!( song_name: "Once Count Seclusion", filename: "07-1161936-Kellee+Maize-Fact+Is+_J.+Glaze+anddachi+Remix_.mp3", length: 216,  artist_id: tiffany_smith.id)
  song40 = Song.create!( song_name: "Moon Sniffing", filename: "08-1161937-Kellee+Maize-Hasta+Abajo+_J.+Glaze+andike+Cash+Remix_.mp3", length: 220,  artist_id: tiffany_smith.id)
  song41 = Song.create!( song_name: "Whispering Silence", filename: "09-1161939-Kellee+Maize-In+the+Night+-+Game+of+Thrones+Remake+_J.+Glaze+mix_.mp3", length: 303, artist_id: tiffany_smith.id)
  ...
  #
  PlaylistSong.create!(song_id: song13.id, playlist_id: playlist14.id)
  PlaylistSong.create!(song_id: song14.id, playlist_id: playlist14.id)
  PlaylistSong.create!(song_id: song15.id, playlist_id: playlist14.id)
  ...
  #
  PlaylistSong.create!(song_id: song22.id, playlist_id: playlist15.id)
  PlaylistSong.create!(song_id: song23.id, playlist_id: playlist15.id)
  PlaylistSong.create!(song_id: song24.id, playlist_id: playlist15.id)
  PlaylistSong.create!(song_id: song25.id, playlist_id: playlist15.id)
  PlaylistSong.create!(song_id: song26.id, playlist_id: playlist15.id)
